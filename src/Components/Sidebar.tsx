...
function Sidebar({ setIsSidebarOpen, isSidebarOpen }: props) {
  ...
  const navsAdmin = [
    ...
    { name: "Dossiers", link: "/dossier", icon: <FaFolder size={20} /> },
    {
      name: "Historiques",
      link: "/historique",
      icon: <RiGuideFill size={20} />,
    },
    { name: "Processus", link: "/processus", icon: <SiAlwaysdata size={20} /> },
    { name: "Parametres", link: "/setting", icon: <Settings size={20} /> },
  ];
  ...
  const navs =
    post === "Chargé de clientèle" || post === "DEVELOPPEUR"
      ? navsChargeClientele
      : navsAdmin;
    ...
    <>
      ...
      >
        ...
        <nav className=" flex flex-col items-center justify-center">
                  ...
                  <div
                    className={`flex flex-col
                            items-center justify-center
                                ${
                                  isActive(item.link) ? "" : "text-main-"
                                } hover:ml-2  p-2   rounded`}
                  >
                    <div
          ...
          <div
            className="mt-3 bottom-9 flex flex-col items-center justify-center cursor-pointer"
            onClick={LogoutFun}
          >
