...
const RemonterStepEntreprise2= ({ligne, closeSecondModal, credit, oncloseFirstModal}:props) => {
    ...
    <div className="w-full mx-auto p-6 bg-white shadow-lg rounded-md space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-800">
          ...
          <div>
            <span className="font-medium">Adresse :</span> {ligne?.client?.Address}
          </div>
          {/* <div>
...
export default RemonterStepEntreprise2;
