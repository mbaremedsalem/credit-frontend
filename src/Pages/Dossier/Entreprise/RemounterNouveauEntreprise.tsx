...
import RemonterStepEntreprise2 from "./RemonterEntrepriseStep2";
...
const RemonterANouveauEntreprise = ({ closeSecondModal, Credit_id }: props) => {
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4 text-sm text-gray-900">
          {docsNormaux?.map((fileObj, idx) => (
            ...
            >
              <span className="text-[14px]">{fileObj.type_document}</span>
              <div
                key={idx}
...
export default RemonterANouveauEntreprise;
