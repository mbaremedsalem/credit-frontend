      ...
      <CardHeader>
        <CardTitle>
          <div className="flex items-center justify-between space-x-2 mb-5">
            ...
            <MdOutlineRealEstateAgent size={35} />
          </div>
        </CardTitle>
      ...
      <div className="flex justify-between mt-3 mb-1">
        ...
        <div className="flex justify-between mb-1 cursor-pointer">
          <div className="flex items-center">
            ...
            <span className="font-bold ml-2 mr-1">Nouakchott</span>
            <span> -  38 </span>
          </div>
        </div>
        </Link>
        ...
        <div className="flex justify-between cursor-pointer">
          <div className="flex items-center">
            ...
            <span className="font-bold ml-2 mr-1 ">Nouadhibout</span>
            <span>- 27</span>
          </div>
        </div>
</Link>
