...
const ChartDelaiTypeCredit = () => {
  ...
  const data: ChartData<'doughnut'> = {
    labels: ["Long Terme", "Moyen Terme", "Courte Terme"],
    datasets: [
      {
        data: [23, 40, 12],
        backgroundColor: ["#7367F0", "#89785A", "#33FFBD"],
        borderWidth: 0,
      },
    ],
  };
  ...
  return (
    <Card className="flex flex-col items- justify-center">
      <CardHeader>
        <CardTitle>
          <div className="flex items-center justify-between space-x-2 mb-5">
            <span className="font-bold text-2xl">Répartition des Crédits par Durée</span>
      ...
      <div className="flex items-center justify-center space-x-2 mt-2 max-md:flex-col">
      
        <Link to={``}>
        <div className="flex justify-between  cursor-pointer">
          <div className="flex items-center">
            <div className="w-4 h-4 bg-[#7367F0] rounded-full cursor-pointer"></div>
            <span className="font-bold ml-2 mr-1 text-[12px]">Long Terme</span>
        ...
        <div className="flex justify-between cursor-pointer">
          <div className="flex items-center">
            ...
            <span className="font-bold ml-2 mr-1 text-[12px]">Moyen Terme</span>
...
<Link to={``}>
        <div className="flex justify-between cursor-pointer">
          <div className="flex items-center">
            ...
            <span className="font-bold ml-2 mr-1 text-[12px]">Court Terme</span>
            <span className="text-[12px]">- 27</span>
          </div>
        </div>
</Link>
...
export default ChartDelaiTypeCredit;
